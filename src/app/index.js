    ...
    return (<SafeAreaView style={styles.safeArea}>
      <View style={styles.appShell}>
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          {currentScreen === "add" && <AddExpense description={description} amount={amount} selectedCategory={selectedCategory} setDescription={setDescription} setAmount={setAmount} setSelectedCategory={setSelectedCategory} onQuickAdd={quickAdd} onSubmit={addExpense}/>}
          {currentScreen === "history" && <History expenses={expenses} searchText={searchText} setSearchText={setSearchText} onDelete={deleteExpense}/>}
          {currentScreen === "budget" && <Budget weeklyBudget={weeklyBudget} monthlyBudget={monthlyBudget} setWeeklyBudget={setWeeklyBudget} setMonthlyBudget={setMonthlyBudget} savedWeeklyBudget={savedWeeklyBudget} savedMonthlyBudget={savedMonthlyBudget} weekTotal={weekTotal} monthTotal={monthTotal} onSave={() => { setSavedWeeklyBudget(Number(weeklyBudget) || 0); setSavedMonthlyBudget(Number(monthlyBudget) || 0); Alert.alert("Budget saved", "Your new limits are active."); }}/>}
...
const colors = { navy: "#102A43", ink: "#172B4D", muted: "#7B8794", white: "#FFFFFF", canvas: "#F4F7F9", border: "#E3EAF0", blue: "#2F80ED", green: "#10B981", mint: "#A7F3D0", orange: "#F59E0B" };
