...
type ExpenseFormProps = { name: string; amount: string; setName: Dispatch<SetStateAction<string>>; setAmount: Dispatch<SetStateAction<string>>; onSubmit: () => void };

// Collects the name and amount needed to create a new expense.
export function ExpenseForm({ name, amount, setName, setAmount, onSubmit }: ExpenseFormProps) {
  return (
    <>
